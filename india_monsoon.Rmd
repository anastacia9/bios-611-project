...
### At the top left, click the layers button below the zoom function. Select "Esri.WorldImagery" to see the satellite view.
latlong <- rains %>%
...
india  <- mapview(latlong, xcol = "Longitude", ycol = "Latitude", crs = 4269, grid = FALSE, zcol="median", col.regions = colors, at = breaks)
india
...
ggsave( paste('figures/median_monthly_rainfall_lineplot',as.character(count),'.png', sep=''), graphs[[count]] )
count <- count + 1 
}
graphs
```
